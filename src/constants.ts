...
export const LEVELS: LevelDef[] = [
  { id: 1, name: 'Tutorial Novice', unlockPoints: 0, pointsToPass: 100, speed: 5, width: 20, height: 15, obstacles: false, poison: false, timeFruits: false, portals: false, bossMode: false, difficulty: 'Easy' },
  { id: 2, name: 'Green Beginnings', unlockPoints: 100, pointsToPass: 250, speed: 6, width: 20, height: 15, obstacles: false, poison: false, timeFruits: false, portals: false, bossMode: false, difficulty: 'Easy' },
  { id: 3, name: 'Speed Challenge', unlockPoints: 350, pointsToPass: 500, speed: 7, width: 20, height: 15, obstacles: false, poison: false, timeFruits: false, portals: false, bossMode: false, difficulty: 'Easy' },
  { id: 4, name: 'Obstacle Intro', unlockPoints: 850, speed: 8, pointsToPass: 750, width: 22, height: 17, obstacles: true, poison: false, timeFruits: false, portals: false, bossMode: false, difficulty: 'Medium' },
  { id: 5, name: 'Rare Fruit Era', unlockPoints: 1600, speed: 9, pointsToPass: 1000, width: 22, height: 17, obstacles: true, poison: false, timeFruits: false, portals: false, bossMode: false, difficulty: 'Medium' },
  { id: 6, name: 'Poison Intro', unlockPoints: 2600, speed: 10, pointsToPass: 1500, width: 24, height: 18, obstacles: true, poison: true, timeFruits: false, portals: false, bossMode: false, difficulty: 'Medium' },
  { id: 7, name: 'Time & Power', unlockPoints: 4100, speed: 11, pointsToPass: 2000, width: 24, height: 18, obstacles: true, poison: true, timeFruits: true, portals: false, bossMode: false, difficulty: 'Hard' },
  { id: 8, name: 'Obstacle Expansion', unlockPoints: 6100, speed: 12, pointsToPass: 2500, width: 26, height: 20, obstacles: true, poison: true, timeFruits: true, portals: false, bossMode: false, difficulty: 'Hard' },
  { id: 9, name: 'Portal Teleport', unlockPoints: 8600, speed: 13, pointsToPass: 3000, width: 26, height: 20, obstacles: true, poison: true, timeFruits: true, portals: true, bossMode: false, difficulty: 'Very Hard' },
  { id: 10, name: 'Boss Mode Chaos', unlockPoints: 11600, speed: 14, pointsToPass: 4000, width: 28, height: 22, obstacles: true, poison: true, timeFruits: true, portals: true, bossMode: true, difficulty: 'Expert' },
  { id: 11, name: 'Chaos Randomness', unlockPoints: 15600, speed: 15, pointsToPass: 5000, width: 30, height: 24, obstacles: true, poison: true, timeFruits: true, portals: true, bossMode: true, difficulty: 'Master' },
  { id: 12, name: 'Master Challenge', unlockPoints: 20600, speed: 16, pointsToPass: 10000, width: 32, height: 24, obstacles: true, poison: true, timeFruits: true, portals: true, bossMode: true, difficulty: 'Master' },
];
